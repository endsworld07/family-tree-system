...
def main() -> None:
    ...
    if svg:
        # The component returns only the clicked person id.  Its key changes
        # after an edit selection, allowing the same person to be clicked
        # again later without being mistaken for an old event.
